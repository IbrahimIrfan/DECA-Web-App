...
</head><body><div id="cssmenu">  <ul><li><a href='index.php'><span>Home</span></a></li><li><a href='about.php'><span>About DECA</span></a></li><li><a href='events.php'><span>Events</span></a></li><li class='active'>
  <a href='dashboard.php'><span>Dashboard</span></a></li>          <li><a href='announcements.php'><span>Announcements</span></a></li>  <li><a href='dates.php'><span>Schedules</span></a></li>  <li><a href='exams.php'><span>Exams</span></a></li><li class='last'><a href='logout.php?logout'><span>Logout</span></a></li></ul></div></br>  <div id='timer-label'>Time Remaining:</div><div class='timer' data-minutes-left=70></div><div class="content"><h4 style="color: red;">IRHS DECA does not own any of these exams.</h4><h4>Principles_Exam_1</h4><h4 id="score" style="color: blue;"></h4><form id="myform"><h5 id='q1'>1. Torts relating to misrepresented facts about a business's goods or services may be subject to a lawsuit
...
</h5><h5>undefined</h5></div><h5 id='q10'>10. In a weekly staff meeting, Morgan presents a set of new procedures that she believes will improve the
...
operating costs.</option></select></br></br><div id="48answer" style="display: none;"><h5>Incorrect. The correct answer is C: Jiffy Parcel Service strives to provide the quickest, most reliable delivery service in the country.</h5><h5>undefined</h5></div><h5 id='q49'>49. Nancy said, “That was a good try, Stanley. Next time you might want to take the opposite approach. You
...
firewall software. The process of updating firewall software is not related to a person's physical safety,
product tampering, or calculation errors.
</h5></div><input id="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" type="submit"></input></form></div></body><script src="http://www.irhsdeca.com/jquery-timer/jquery.simple.timer.js"></script><script src="http://www.irhsdeca.com/exams/Principles/Principles_1_Whole_Master.js"></script></html>
