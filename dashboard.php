...
$add_Event = mysql_query("UPDATE users SET userEventAssigned='HRM' WHERE userId=703");
$add_Event2 = mysql_query("UPDATE users SET userEventAssigned='PBM' WHERE userId=704");
