...
should strive to be</h5><select class="select-style" id="_10"><option value="def" disabled selected>Select</option><option value="A">A. respectful, indifferent, and honest.</option><option value="B">B. confident, biased, and manipulative.</option><option value="C">C. sensitive, transparent, and demanding.</option><option value="D">D. patient, flexible, and empathetic.</option></select></br></br><div id="10answer" style="display: none;"><h5>Incorrect. The correct answer is D: patient, flexible, and empathetic.</h5><h5>undefined</h5></div><h5 id='q11'>11. Which of the following situations is an unethical action associated with customer relationship
...
3
</h5><h5>undefined</h5></div><h5 id='q21'>21. Irish businessperson Nicole McMurray wanted to give Mrs. Fukushima, the wife of a well-known
...
account.</h5><h5>undefined</h5></div><h5 id='q26'>26. Joe has a two-hour sales meeting with a new customer at 10 a.m. today. Early this morning, a vendor
...
4
</option></select></br></br><div id="27answer" style="display: none;"><h5>Incorrect. The correct answer is A: manage your work commitments effectively. </h5><h5>undefined</h5></div><h5 id='q28'>28. While negotiating a contract, Angela gives up one thing she wants, so she has leverage to obtain
...
parties.</h5><h5>undefined</h5></div><h5 id='q50'>50. Mr. Edwards saved some confidential customer information from his employer's computer network onto a
...
3
</h5><h5>undefined</h5></div><input id="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" type="submit"></input></form></div></body><script src="jquery-timer/jquery.simple.timer.js"></script><script src="exams/Business-Admin/Business-Admin_1_Whole_Master.js"></script></html>