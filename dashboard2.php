...
$add_event = mysql_query("UPDATE users SET userEventAssigned='BSM' WHERE userId=709");
$add_event2 = mysql_query("UPDATE users SET userEventAssigned='AAM' WHERE userId=710");
