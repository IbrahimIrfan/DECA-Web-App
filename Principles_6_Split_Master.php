...
</h5></div><h5 id='q15'>15. To make a request of a business associate or customer is one of the reasons why businesspeople write</h5><select class="select-style" id="_15"><option value="def" disabled selected>Select</option><option value="A">A. corporate memorandums.</option><option value="B">B. persuasive messages.</option><option value="C">C. sales letters.</option><option value="D">D. letters of inquiry.</option></select></br></br><div id="15answer" style="display: none;"><h5>Incorrect. The correct answer is D: letters of inquiry.</h5><h5>Explanation not available</h5></div><h5 id='q16'>16. A message from the company president to all employees concerning a change in insurance coverage is
...
</h5><h5>Explanation not available</h5></div><h5 id='q38'>38. To be considered a person with initiative, you must</h5><select class="select-style" id="_38"><option value="def" disabled selected>Select</option><option value="A">A. cooperate with those who have initiative.</option><option value="B">B. practice initiative from time to time.
...
</h5><h5>Explanation not available</h5></div><h5 id='q70'>70. ChemTech International plans to build a new research facility, which is to be completed in two years. As
...
</h5><h5>Explanation not available</h5></div><h5 id='q93'>93. Employees who arrive at work on time and direct their own work-related activities during the course of the
...
and their total purchases are more likely to increase than decrease. Customers may need to ask fewer
questions when their inquiries are handled in an effective manner.
</h5></div><input id="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" type="submit"></input></form></div></body><script src="jquery-timer/jquery.simple.timer.js"></script><script src="exams/Principles/Principles_6_Split_Master.js"></script></html>