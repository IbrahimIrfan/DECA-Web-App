...
resources (oil, coal, gas, etc.). Air and water are presently in abundant supply in America. Money is a
symbol of value, not a natural resource.
</h5></div><input id="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" type="submit"></input></form></div></body><script src="jquery-timer/jquery.simple.timer.js"></script><script src="Finance_3_Split_Homework.js"></script></html>