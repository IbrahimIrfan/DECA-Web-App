...
</h5></div><h5 id='q15'>15. Businesses use technology to build positive customer relations by</h5><select class="select-style" id="_15"><option value="def" disabled selected>Select</option><option value="A">A. calling customers at home.</option><option value="B">B. creating targeted marketing campaigns.</option><option value="C">C. placing pop-up advertisements on web sites.</option><option value="D">D. sending unsolicited e-mails.</option></select></br></br><div id="15answer" style="display: none;"><h5>Incorrect. The correct answer is B: creating targeted marketing campaigns.</h5><h5>undefined</h5></div><h5 id='q16'>16. A positive result of handling customer complaints properly is that it will</h5><select class="select-style" id="_16"><option value="def" disabled selected>Select</option><option value="A">A. increase returns.</option><option value="B">B. promote goodwill.</option><option value="C">C. foster objections.</option><option value="D">D. increase markdowns.</option></select></br></br><div id="16answer" style="display: none;"><h5>Incorrect. The correct answer is B: promote goodwill.</h5><h5>Goodwill is a positive feeling a person has toward a business. Properly settling
...
</h5><h5>undefined</h5></div><h5 id='q48'>48. Bennett has just finished college and has moved into her own apartment that is located on a bus line.
...
an insurance company.</h5><h5>undefined</h5></div><h5 id='q91'>91. As an employee of a financial-services firm, Elise helps her clients reduce their debt, build their wealth,
...
income that they can decide to spend or save. Capital investment is the funds used to start and to
maintain a business. Wants are wishes or longing for things that are lacking, and they are unlimited.
</h5></div><input id="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" type="submit"></input></form></div></body><script src="jquery-timer/jquery.simple.timer.js"></script><script src="exams/Finance/Finance_4_Split_Master.js"></script></html>