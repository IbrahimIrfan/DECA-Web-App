...
facilitated communication and exchange of payments. Government, culture, and exchange rates have
both facilitated and hampered global trade.
</h5></div><input id="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" type="submit"></input></form></div></body><script src="jquery-timer/jquery.simple.timer.js"></script><script src="Marketing_1_Split_Homework.js"></script></html>