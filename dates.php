...
<body>
  ...
  <div class="regionals">
    ...
    <img src="img/location.png" align="left" width="50" style="padding-right: 20px; padding-left: 15px;"/>
    <h5 style="margin-top: 30px;">Hamilton Convention Centre</h5><br/>
    <img src="img/date.png" align="left" width="50" style="padding-right: 20px; padding-left: 15px;"/>
    <h5 style="margin-top: 20px;">Online Exams: October 31 || Case Studies: November 8</h5><br/>
    <img src="img/money.png" align="left" height="50" style="padding-right: 20px; padding-left: 15px;"/>
