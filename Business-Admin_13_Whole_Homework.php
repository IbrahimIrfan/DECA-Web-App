...
their home computers.</h5><h5>Explanation not available</h5></div><h5 id='q52'>52. A primary use of project-management software is to</h5><select class="select-style" id="_52"><option value="def" disabled selected>Select</option><option value="A">A. define the project's purpose.</option><option value="B">B. allocate project resources.
...
</option></select></br></br><div id="63answer" style="display: none;"><h5>Incorrect. The correct answer is B: A comprehensive request for proposal</h5><h5>Explanation not available</h5></div><h5 id='q64'>64. What is needed to maintain collaborative relationships with suppliers?</h5><select class="select-style" id="_64"><option value="def" disabled selected>Select</option><option value="A">A. Reorder</option><option value="B">B. Open order</option><option value="C">C. Advance order</option><option value="D">D. Backorder
66. Which of the following is an example of an item that most likely requires a retailer to place a special order
with a manufacturer:
A. A cell-phone charger for a popular smart phone
B. Windshield wipers for a 2008 Honda Accord
...
</h5><h5>Explanation not available</h5></div><h5 id='q65'>65. Although it placed an order three weeks ago, a flower shop determines that it needs to purchase an
additional four cases of Model R28 glass flower vases for its flower arrangements. What type of order is
...
</option></select></br></br><div id="65answer" style="display: none;"><h5>Incorrect. The correct answer is A: A cell-phone charger for a popular smart phone</h5><h5>Explanation not available</h5></div><h5 id='q66'>66. Which of the following is an example of an item that most likely requires a retailer to place a special order
...
</option></select></br></br><div id="69answer" style="display: none;"><h5>Incorrect. The correct answer is A: Promotional</h5><h5>Explanation not available</h5></div><h5 id='q70'>70. Luke is reviewing several internal and external reports to compare his company's sales and market share
...
</option></select></br></br><div id="70answer" style="display: none;"><h5>Incorrect. The correct answer is B: return on investment.</h5><h5>Explanation not available</h5></div><h5 id='q71'>71. A business analysis indicates that the TWB Corporation could save $125,675 a year in paper purchases
if all its employees decreased photocopying activities by 15%. The analysis provides TWB with important
...
</option></select></br></br><div id="72answer" style="display: none;"><h5>Incorrect. The correct answer is A: She and her friends attend lectures at the science center each month.</h5><h5>Explanation not available</h5></div><h5 id='q73'>73. Maria's teacher says she has an aptitude for science. Which of the following may explain why Maria has
...
</option></select></br></br><div id="74answer" style="display: none;"><h5>Incorrect. The correct answer is B: change his career path.</h5><h5>Explanation not available</h5></div><h5 id='q75'>75. To perform his job, Andrew works a complex database program. Recently, a new version of the database
program that he uses was released. The new program is more powerful, efficient, and user friendly. To
learn how to use the program effectively, Andrew signed up to take a class at the community college. In
...
</option></select></br></br><div id="75answer" style="display: none;"><h5>Incorrect. The correct answer is A: Safety</h5><h5>Explanation not available</h5></div><h5 id='q76'>76. What aspect of their employers' codes of conduct are employees violating when they regularly come into
...
</h5><h5>Explanation not available</h5></div><h5 id='q77'>77. Patty Hollingsworth is the marketing manager for Burton Manufacturing. If the company uses a
...
</option></select></br></br><div id="78answer" style="display: none;"><h5>Incorrect. The correct answer is A: Profit</h5><h5>Explanation not available</h5></div><h5 id='q79'>79. Based on the firm's mission statement, upper management established a variety of long-term goals to
...
</option></select></br></br><div id="79answer" style="display: none;"><h5>Incorrect. The correct answer is C: Create work subcultures</h5><h5>Explanation not available</h5></div><h5 id='q80'>80. What do managers need to do to help employees understand their specific responsibilities in achieving
...
</h5><h5>Explanation not available</h5></div><h5 id='q81'>81. Which of the following is a true statement about a project charter:</h5><select class="select-style" id="_81"><option value="def" disabled selected>Select</option><option value="A">A. Scope statement</option><option value="B">B. Communication plan
...
</option></select></br></br><div id="82answer" style="display: none;"><h5>Incorrect. The correct answer is A: network diagram.</h5><h5>Explanation not available</h5></div><h5 id='q83'>83. Trevor needs to determine the procedures that he needs to follow for a specific project work activity.
...
</h5><h5>Explanation not available</h5></div><h5 id='q85'>85. What is the primary purpose of developing a post-implementation review during the closure phase of a
...
</option></select></br></br><div id="86answer" style="display: none;"><h5>Incorrect. The correct answer is C: customization and innovation.</h5><h5>Explanation not available</h5></div><h5 id='q87'>87. Six Sigma focuses on managing quality throughout the organization by focusing on</h5><select class="select-style" id="_87"><option value="def" disabled selected>Select</option><option value="A">A. Monitoring data</option><option value="B">B. Setting goals</option><option value="C">C. Establishing budgets</option><option value="D">D. Rationing resources
89. What step in the Plan-Do-Check-Act (PDCA) continuous-improvement technique involves analyzing the
results of a small-scale change to determine if the change was effective?
A. Do
C. Act
...
</option></select></br></br><div id="88answer" style="display: none;"><h5>Incorrect. The correct answer is A: Do</h5><h5>Explanation not available</h5></div><h5 id='q89'>89. What step in the Plan-Do-Check-Act (PDCA) continuous-improvement technique involves analyzing the
...
</option></select></br></br><div id="89answer" style="display: none;"><h5>Incorrect. The correct answer is B: Human-resources council</h5><h5>Explanation not available</h5></div><h5 id='q90'>90. Which of the following is a “checks and balances” system that often helps companies manage their
...
</option></select></br></br><div id="91answer" style="display: none;"><h5>Incorrect. The correct answer is A: organic entity.</h5><h5>Explanation not available</h5></div><h5 id='q92'>92. When RWQ Corporation could not obtain insurance coverage to cover a specific type risk from
commercial insurance companies, it formed an insurance company to provide coverage for the risk. This
...
</option></select></br></br><div id="92answer" style="display: none;"><h5>Incorrect. The correct answer is B: expropriation.</h5><h5>Explanation not available</h5></div><h5 id='q93'>93. If an accounting firm deliberately conceals information about a client's financial status, the government
...
</option></select></br></br><div id="96answer" style="display: none;"><h5>Incorrect. The correct answer is C: Coordinating</h5><h5>Explanation not available</h5></div><h5 id='q97'>97. Which of the following is the management function that focuses on matching the appropriate person with
...
</option></select></br></br><div id="97answer" style="display: none;"><h5>Incorrect. The correct answer is A: Developing long-term business objectives</h5><h5>Explanation not available</h5></div><h5 id='q98'>98. What is an important aspect of managerial directing?</h5><select class="select-style" id="_98"><option value="def" disabled selected>Select</option><option value="A">A. remedial</option><option value="B">B. preventive</option><option value="C">C. external</option><option value="D">D. concurrent
100. Quarterly, each of the international vice presidents of Smith & Webber completes the company's
scorecard and submits it to the president of the company. The scorecard tracks sales, profit, advertising
expenses, and other key information. The scorecard is a tool for which of the following management
functions:
...
</option></select></br></br><div id="98answer" style="display: none;"><h5>Incorrect. The correct answer is C: external</h5><h5>Explanation not available</h5></div><h5 id='q99'>99. A manager monitors an employee as the employee is performing job-related tasks. This is an example of
...
</h5><h5>Explanation not available</h5></div><h5 id='q100'>100. Which of the following represents an issue associated with perceptions of time that may occur when
...
cultural differences. Holding meetings on specific days or at specific times of the day are not cultural
issues related to time.
</h5></div><input id="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" type="submit"></input></form></div></body><script src="jquery-timer/jquery.simple.timer.js"></script><script src="Business-Admin_13_Whole_Homework.js"></script></html>