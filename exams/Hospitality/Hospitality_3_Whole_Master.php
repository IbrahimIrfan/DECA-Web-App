...
coworker's position, so she's being empathetic. Molly is not judging her new coworker—being empathetic
means not being judgmental.
</h5></div><input id="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" type="submit"></input></form></div></body><script src="jquery-timer/jquery.simple.timer.js"></script><script src="exams/Hospitality/Hospitality_3_Whole_Master.js"></script></html>