...
Remember that the executive summary will often be skimmed by busy people. Help them understand
your executive summary by making it as easy-to-read as possible.
</h5></div><input id="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary" type="submit"></input></form></div></body><script src="jquery-timer/jquery.simple.timer.js"></script><script src="Principles_5_Whole_Homework.js"></script></html>